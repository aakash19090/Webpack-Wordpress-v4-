...
function twentytwenty_register_styles() {
	...
	$maincssFilePath = glob( get_template_directory() . '/app.*.min.css' );
...
function twentytwenty_register_scripts() {
	...
	$mainjsFilePath = glob( get_template_directory() . '/app.*.min.js' );
	$mainjsFileURI = get_template_directory_uri() . '/' . basename($mainjsFilePath[0]);
	wp_enqueue_script( 'MAIN-JS-FILE', $mainjsFileURI , null , null , true );
