...
function twentytwenty_register_styles() {
	...
	// Dynamically Include Bundled Stylesheet generated by Webpack
	$maincssFilePath = glob( get_template_directory() . '/bundle.*.min.css' );
	$maincssFileURI = get_template_directory_uri() . '/' . basename($maincssFilePath[0]);
	wp_enqueue_style( 'MAIN-CSS-FILE', $maincssFileURI , null , null );
...
function twentytwenty_register_scripts() {
	...
	// Dynamically Include Bundled JS Scripts generated by Webpack
	$mainjsFilePath = glob( get_template_directory() . '/bundle.*.min.js' );
	$mainjsFileURI = get_template_directory_uri() . '/' . basename($mainjsFilePath[0]);
	wp_enqueue_script( 'MAIN-JS-FILE', $mainjsFileURI , array( 'jquery' ) , null , true );
